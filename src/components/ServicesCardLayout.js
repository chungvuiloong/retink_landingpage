        ...
        <>
            <div className="container">
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4">
                    <div class="col ">
                        <div class="card h-100 border-0">
                            ...
                            <div class="card-body">
                                ...
                                <hr />
                                <p class="card-text mt-4">Create a distinct logo designed to express and represent your brand identity.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        ...
                        <div class="card-body">
                            ...
                            <hr />
                            <p class="card-text mt-4">Write SEO enriched blog posts as long or short articles on any topic of your choice.</p>
                        </div>
                        </div>
                    </div>
                    <div class="col">
                    ...
                    <div class="col ">
                        <div class="card h-100 border-0">
                        <img src="https://retink.io/dole777-gPet7PdxI1Q-unsplash.jpg" class="border"  alt="social_media" style={{ height: "68%", borderRadius: "25px"}}/>
                        <div class="card-body">
                            <h3 class="card-title" >Social Media Ads</h3>
                            <hr sx={{ opacity: "0"}} />
                            <p class="card-text mt-4">Boost sales and awareness with tailor made ads from experts.</p>
                        </div>
                        </div>
                    </div>
                </div>
